...
from recommendation_engine import get_custom_recommendations
...
if menu == "Market Segmentation":
    ...
    st.write("Define your ideal phone specs to find the closest matching high-performing alternatives.")
